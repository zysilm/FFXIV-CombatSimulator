...
| [03-combat-engine.md](03-combat-engine.md) | Combat Engine | Damage formula, action pipeline, cooldowns, combos, state |
| [04-network-safety.md](04-network-safety.md) | Network Safety | UseAction hook, defense-in-depth, safety rules |
| [05-animation-vfx.md](05-animation-vfx.md) | Animation/VFX | ActionEffect fabrication, death anims, flytext |
| [06-npc-ai.md](06-npc-ai.md) | NPC AI | State machine, behaviors, presets, movement, casting |
| [07-ui.md](07-ui.md) | UI Layer | ImGui windows, HP bar overlay, combat log |

## Reading Order

For first-time readers: 00 → 01 → 04 → 02 → 03 → 05 → 06 → 07
